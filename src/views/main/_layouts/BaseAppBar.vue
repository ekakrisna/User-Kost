<template>
  <v-app-bar flat app :style="{ background: '#000000' }">
    <v-btn icon color="white" @click="toggleDrawer(!drawerOpen)">
      <v-icon>
        {{ drawerOpen ? 'mdi-chevron-left' : 'mdi-menu' }}
      </v-icon>
    </v-btn>
    <!--<v-spacer></v-spacer>-->
    <p class="text-center mb-0" style="color:#fff; width:100%;">CLUB ICHIJO</p>
